...
public class MainActivity extends AppCompatActivity {
    ...
    public void openMonitor(){
        ...
        MqttClient_alarm.connectToBroker(getApplicationContext(), t_brokerIp.getText().toString(), t_brokerPort.getText().toString(), t_clientId.getText().toString(), new IMqttActionListener() {
            @Override
            public void onSuccess(IMqttToken asyncActionToken) {
                tv_connectionStatus.setText("Connection done!");
                MqttClient_alarm.deviceId = t_deviceId.getText().toString();
