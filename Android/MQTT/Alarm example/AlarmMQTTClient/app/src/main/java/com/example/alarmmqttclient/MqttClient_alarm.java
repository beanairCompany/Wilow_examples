...
public class MqttClient_alarm extends AppCompatActivity{

    public static String deviceId = "";
    private static MqttClient_alarm ldcMqttClient = null;
    ...
    private MqttClient_alarm(Context context, String brokerIp, String brokerPort, String clientId, IMqttActionListener iMqttActionListener){
        try {
...
/*
    public static MqttClient_alarm connectToBroker(Context context, String brokerIp, String brokerPort, String clientId, IMqttActionListener iMqttActionListener){
        if(ldcMqttClient==null)
            ldcMqttClient = new MqttClient_alarm(context, brokerIp, brokerPort, clientId, iMqttActionListener);
