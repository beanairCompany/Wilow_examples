 ...
 * Use the {@link Fragment_inclinometer_x#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Fragment_inclinometer_x extends Fragment {

    TextView tv_alarm_incX;
    LineChart chart;
    long tsLong;

    public Fragment_inclinometer_x() {
        // Required empty public constructor
    }

    // TODO: Rename and change types and number of parameters
    public static Fragment_inclinometer_x newInstance() {
        Fragment_inclinometer_x fragment = new Fragment_inclinometer_x();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_inclinometer_x, container, false);
    }
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if(isVisibleToUser){
            ...
            handler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    final String ChanneTopic = MqttClient_alarm.deviceId+"/SENSOR/3";
                    tv_alarm_incX =  (TextView) getView().findViewById(R.id.tv_alarm_incX);
                    tsLong = System.currentTimeMillis();
                    chart = (LineChart)getView().findViewById(R.id.chart_incX);
                        ...
                        public void messageArrived(String topic, MqttMessage mqttMessage) throws UnsupportedEncodingException {
                            if (isAlarm(mqttMessage.getPayload())) {
                                if(topic.equals(ChanneTopic)) {
                                    tv_alarm_incX.setText(get_alarmStatus(mqttMessage.getPayload()));
